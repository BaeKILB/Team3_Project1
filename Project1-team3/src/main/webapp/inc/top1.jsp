<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<header id="header">
		<div class="wrapper">
			...
			<nav class="nav">
				<ul class="gnb">
					<li class="gnb_cont"><a href="${pageContext.request.contextPath }/html/car_res.jsp">차량예약</a></li>
					<li class="gnb_cont"><a href="${pageContext.request.contextPath }/html/res_inq.jsp">차량안내</a></li>
					<li class="gnb_cont"><a href="${pageContext.request.contextPath }/html/member.jsp">고객센터</a>
						<ul class="sub_menu shadow" style="display: none;">
							<li><a href="#">공지사항</a></li>
							<li><a href="#">FAQ</a></li>
							<li><a href="#">1:1 문의</a></li>
						</ul></li>
					<li class="gnb_cont"><a href="#">예약확인</a></li>
				</ul>
				<ul class="login_section">
					<li><a href="${pageContext.request.contextPath }/html/login.jsp"> <i class="xi-user"></i> 로그인
					</a></li>
					<li class="btn_register"><a href="#"> 회원가입 </a></li>
				</ul>
			</nav>
		</div>
	</header>
		...
		<div class="menu">
			<div class="menu_wrap">
				...
				<ul class="menu_section">
					<li class="gnb_cont"><a href="#">차량예약</a></li>
					<li class="gnb_cont"><a href="#">차량안내</a></li>
					...
					<li class="gnb_cont"><a href="#">예약안내</a></li>
					<ul class="login_section">
						<li><a href="#"> <i class="xi-user"></i> 로그인
						</a></li>
						<li><a href="#"> <i class="xi-user"></i> 회원가입
						</a></li>
					</ul>
				</ul>
				<div class="btn_close">
