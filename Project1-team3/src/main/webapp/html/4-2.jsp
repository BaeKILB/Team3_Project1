	...
	<form>
			<ul class="side_menu">
                    <li>
                        ...
                        <ul class="side_sub">
							...
							<li>
								...
								<select id="rental_area2">
							     <option value="">범일점(본점)</option>
							     <option value="">oo점</option>
							     <option value="">oo점</option>
							     <option value="">oo점</option>
							    </select>
							</li>
                        ...
                        <div class="menu_tit driver_info">
                            <span>운전자정보(필수입력)</span>
                        </div>
                        <ul class="side_sub">
                            <li>
                                <label for ="name">운전자명</label>
								<input type="text" name=" " style="width:150px" placeholder="내용을 입력해 주세요" >
							</li>
							<li>
							...
							<li>
								...
								<select name="id_type2">
							  	...
							  	</select>-<input type="text" name=" " style="width:150px" placeholder="내용을 입력해 주세요" >
							</li>
							<li>
                        ...
                        <ul class="side_sub">
                            <li>
							   ...
							   <table class="table1">
							    ...
							    <tr id="tr1">
							      <th><input type="radio" value=" " name=" ">선택안함</th>
							      <td>없음</td>
							      <td>없음</td>   
							      <td>전액부담</td>   
							    </tr>
							    <tr>
							      <th><input type="radio" value=" " name=" ">일반자차</th>
							      <td>1만원</td>
							      <td>300만원</td>   
							      <td>30만원</td>   
							    </tr>
                    ...
                    <li>
                        ...
                        <div class="menu_tit payment">
                            <span>결제수단 선택</span>
                        </div>
                        <ul class="side_sub">
                            <li>
                            	<div class="payment" id="box1"><input type="radio" name="payment" id="card">신용/체크카드</div>
		  						<div class="payment" id="box2"><input type="radio" name="payment" id="virtual_account">가상계좌이체</div>
		  						<div class="payment" id="box3"><input type="radio" name="payment" id="transfer">무통장입금</div>
                            </li>
                        </ul>
                   	 </li>
					<li>
                        <div class="menu_tit agreement">
                            <span>이용약관</span>
                        </div>
                        <ul class="side_sub">
                            <li>
                               <textarea name="tos" rows=15 cols=100>자동차대여 표준약관
제1장 총칙제1조(약관의 적용)
